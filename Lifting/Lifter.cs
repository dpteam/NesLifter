...
namespace NesLifter.Lifting
{
    public sealed class Lifter
    {
        ...
        private void AppendMapper(StringBuilder sb)
        {
            ...
            sb.AppendLine("        }");
            sb.AppendLine();
            sb.AppendLine("        // Mapper 2: UxROM");
            sb.AppendLine("        if (Runtime.Mapper == 2)");
            sb.AppendLine("        {");
            sb.AppendLine("            int lastBank = (Runtime.PrgRom.Length / 0x4000) - 1;");
            sb.AppendLine("            if (lastBank < 0) lastBank = 0;");
            sb.AppendLine("            SetPrg16(0x8000, 0);");
            sb.AppendLine("            SetPrg16(0xC000, lastBank);");
            sb.AppendLine("            SetChr8(0);");
            sb.AppendLine("            return;");
            sb.AppendLine("        }");
            sb.AppendLine();
            sb.AppendLine("        // Mapper 3: CNROM");
            ...
            sb.AppendLine("    }");
            sb.AppendLine();
            sb.AppendLine("    // === PRG setters: база КОНСТАНТНА внутри региона ===");
            ...
            sb.AppendLine("        {");
            sb.AppendLine("            int p = page + i;");
            sb.AppendLine("            if (p < 32) { PrgPageMem[p] = Runtime.PrgRom; PrgPageBase[p] = baseOff; PrgPageIsRam[p] = false; }");
            sb.AppendLine("        }");
            sb.AppendLine("    }");
            sb.AppendLine();
            ...
            sb.AppendLine("        ChrPageMem[page] = Runtime.ChrRom;");
            sb.AppendLine("        ChrPageBase[page] = bank * 0x400 - addr;");
            sb.AppendLine("        ChrPageIsRam[page] = false;");
            sb.AppendLine("    }");
            sb.AppendLine();
            ...
            sb.AppendLine("        {");
            sb.AppendLine("            int p = page + i;");
            sb.AppendLine("            if (p < 8) { ChrPageMem[p] = Runtime.ChrRom; ChrPageBase[p] = baseOff; ChrPageIsRam[p] = false; }");
            sb.AppendLine("        }");
            sb.AppendLine("    }");
            sb.AppendLine();
            ...
            sb.AppendLine("        for (int i = 0; i < 8; i++)");
            sb.AppendLine("        {");
            sb.AppendLine("            ChrPageMem[i] = Runtime.ChrRom;");
            sb.AppendLine("            ChrPageBase[i] = bank * 0x2000;");
            sb.AppendLine("            ChrPageIsRam[i] = false;");
            sb.AppendLine("        }");
            sb.AppendLine("    }");
            sb.AppendLine();
            ...
            sb.AppendLine("            int lastBank = (Runtime.PrgRom.Length / 0x4000) - 1;");
            sb.AppendLine("            if (lastBank < 0) lastBank = 0;");
            sb.AppendLine("            SetPrg16(0x8000, value & 0x0F);");
            sb.AppendLine("            return;");
            sb.AppendLine("        }");
            sb.AppendLine();
            sb.AppendLine("        // Mapper 3: CNROM");
            sb.AppendLine("        if (Runtime.Mapper == 3)");
            sb.AppendLine("        {");
            sb.AppendLine("            int banks = Runtime.ChrRom.Length / 0x2000;");
            sb.AppendLine("            if (banks > 0) SetChr8(value % banks);");
            sb.AppendLine("            return;");
            sb.AppendLine("        }");
            sb.AppendLine("    }");
            sb.AppendLine("}");
